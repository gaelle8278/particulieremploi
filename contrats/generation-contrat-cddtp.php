<?php
/**
* Génération du PDF pour le contrat CDD à terme précis
*/
...
$pdf->ln(2);
$pdf->writeHTMLCell('','','','',"Le(a) salarié(e) est embauché(e) en contrat à durée déterminée à compter du ......./......./...... dans le cadre de ............................",0,1,0,true,'J',true, false);
$pdf->ln(2);
$pdf->writeHTMLCell('','','','',"Le présent contrat est conclu pour une durée de … semaines/mois et prendra automatiquement fin le ......../......../......... inclus. ",0,1,0,true,'J',true, false);
$pdf->ln(5);
...
Durant cette période d'essai, chacune des parties pourra mettre fin au contrat, sans indemnités.";
...
$textPE2="En cas de rupture du fait de l' employeur, ce dernier devra respecter un délai de prévenance égal à : <br>
...
//renouvellement
$pdf->SetTextColor(239,137,20);
$pdf->writeHTMLCell('','','','',"Renouvellement : ",0,1,false,true,'L',true, false);
$pdf->ln(1);
$pdf->SetTextColor(0,0,0);
$textRenouvellement="Le contrat pourra être renouvelé deux fois pour une durée déterminée, dans des conditions qui feront l'objet 
 d'un avenant soumis au (à la) salarié(e) préalablement au terme du présent contrat et préalablement au terme du premier renouvellement. ";
$pdf->writeHTMLCell('','','','',$textRenouvellement,0,1,false,true,'J',true, false);
$pdf->ln(5);
...
$pdf->writeHTMLCell(100,'',$xpos,'',"A TERME PRECIS",0,1,true,true,'C');
$pdf->ln(5);
...
Le(a) salarié(e) est embauché(e) en contrat à durée déterminée à compter du (Date du premier jour de la relation de travail.) 
dans le cadre de (Indiquer le motif de recours au CDD).<br>
<br>
Le présent contrat est conclu pour une durée de ........... semaines/mois et prendra automatiquement fin le (Indiquer le dernier jour de travail) inclus. <br>
<br>
...
$texteColDroite="&bull; <b>Domaine « Espaces de vie »</b> (notamment l'entretien du domicile : ménage, repassage) (cliquez <a href=\"http://www.fepem.fr/documents/10163/1274052/ANNEXE+3+domaine+espaces+de+vie+_Avril2016.pdf\">ici</a>) ;<br>
<br>
...
$texteColDroite1="Indemnité forfaitaire au moins égale à 1/6ème du salaire conventionnel minimal pour une même durée de travail effectif.<br> 
<br>
<b><span style=\"color:#EF8914;\">Renouvellement : </span></b><br>
L'employeur peut renouveler le contrat à durée déterminée dont le terme est précis à deux reprises. <br>
Le double renouvellement ne devra pas déroger à la durée maximale de 18 mois prévue par la loi (sauf exceptions). <br>
<br>
<br>";
