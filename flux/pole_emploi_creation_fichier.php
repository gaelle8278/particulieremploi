<?php
/**
 * Script de création de fichier csv
 */
...
fwrite($fplog, "Début création du fichier le ".$currentDate." à ".$currentHour."\r\n");
...
fwrite($fplog, "Début création fichier \r\n");
...
$limiteValidite = date ("Y-m-d", mktime(0,0,0,date("m"),date("d")-90,date("Y")));
$reqAnnonces="SELECT annonce_id,annonce_idmetier,annonce_description, annonce_experience, annonce_ville,annonce_codepostal, annonce_datecrea "
        ...
        . "and annonce_diffusionpe=1 "
        . "and annonce_description !='' "
        . "and annonce_description is not null "
        . "and annonce_excludetoexport!=1";
...
foreach ($resReqAnnonces as $result){
   ...
   //url de l'annonce
    $offUrl='http://www.particulieremploi.fr/pe/espace-pe/details-offre.php?id='.$result['annonce_id'];
