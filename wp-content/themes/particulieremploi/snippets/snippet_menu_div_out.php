...
foreach ( $menu_items as  $menu_item) {
            ...
            if ( !$menu_item->menu_item_parent ) {
                ...
                //si l'élément a des enfants
                    ...
                    $menu_list_main .= "<li id='".$menu_item->ID."'>".$title."</li>";
                }
            ...
            if ( $parent_id == $menu_item->menu_item_parent ) {
                ...
                if ( !$sub_menu ) {
                    $sub_menu=true;
                    $menu_list_sub .= "<div class='sub-menu' id='sub_".$menu_item->menu_item_parent."'><ul>";
                }
                ...
                if($menu_items[  $count + 1 ]->menu_item_parent != $subparent_id) {
                     $menu_list_sub .= "<li><a href='".$link."'>".$title."</a></li>";
                } else if ($menu_items[  $count + 1 ]->menu_item_parent == $subparent_id) {
                     $menu_list_sub .= "<li>".$title
                             . "<ul id='".$menu_item->ID."'>";
                }
