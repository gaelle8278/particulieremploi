...
/**
 * Affichage d'un header sans navigation
 *
 * @package WordPress
...
<!--[if (gt IE 8)&!(IEMobile)]><!--> <html lang="fr" class="no-js"> <!--<![endif]-->
    ...
    <body <?php body_class(); ?>>
        ...
        <div class="container blur-effect">
                        ...
                        --><div class="header-section buttons-section">
                            ...
                            if(isset($_SESSION['utilisateur_id']) && !empty($_SESSION['utilisateur_id'])) {
                                ...
                                <div class="user-menu-section">
                                    <ul>
                                        <li><a href="/pe/espace-pe/compte.php" title="Accès à mon espace de mise en relation"><?php echo ucwords($_SESSION['utilisateur_nomprenom']); ?></a>
                                            <ul>
                                                <li><a href="/pe/espace-pe/compte.php" title="Accès à mon espace de mise en relation"> Mon compte </a></li>
                                ...
                                <div class="header-button espace-relation">
                                    <a href="/pe/espace-pe/connexion.php" class="popup-button" data-modal="popup">Accès à mon espace <br />de mise en relation</a>
                                <?php
                            }
                            ?>
                            </div><!-- @whitespace
