...
/**
 * Template Name: Les formules d'accompagnement FEPEM
 *
 * @package WordPress
    ...
    <div class="content-central-column section-content">
        <div class="bloc-page-offre">
            <div class="bloc-page-wrap">
                <h1 class="section-content-title">Vous êtes membre de la FEPEM ?</h1>
                <div class="section-content-separator"></div>
                <p class="text-teaser">
                    Bénéficiez d'un accompagnement personnalisé par un juriste expert<br>
                    à tous les moments clés de la relation de travail
                </p>
            </div>
        </div>
        <div class="bloc-page-offre">
                        ...
                        <div class="contact-postal">
                            ...
                            <p>
                                Je télécharge <a class="content-link"
                                  href="http://particulieremploi.fr/wp-content/uploads/2017/01/FEPEM_souscription-services_Bulletin-papier_Membres.doc"
